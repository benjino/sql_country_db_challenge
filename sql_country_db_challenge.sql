...
country
WHERE
governmentform = 'Republic' AND indepyear > 1945
...
-- Of the smallest 10 country's populations, which has the biggest gnp? (hint: use WITH and LIMIT)
...
-- Of the smallest 10 country's populations, which has the biggest per capita gnp?
